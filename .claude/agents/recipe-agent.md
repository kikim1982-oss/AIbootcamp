...
| Classic | Light |
|:------|:------|
| **01** {단계 1} | **01** {저칼로리 단계 1} |
| **02** {단계 2} | **02** {저칼로리 단계 2} |
| **03** {단계 3} | **03** {저칼로리 단계 3} |
| ... | ... |
...
|:------|:------|
| {풍미를 극대화하는 조리 기법} | {칼로리를 절감하면서도 맛을 유지하는 기법} |
| {재료의 과학적 특성을 활용한 팁} | {저칼로리 재료 대체 가이드} |
| {효율적인 동선 및 정리 팁} | {건강한 페어링 제안} |
...
14. 모든 문체는 포멀하고 품격 있는 어조를 유지하세요 — 캐주얼한 표현, 이모지 남용을 지양합니다

## 완료 전 품질 확인
- 마크다운의 이미지 경로(커버, 조리 과정)가 실제 파일 위치와 일치하는지 확인하세요
- 모든 조리 단계가 초보자도 이해할 수 있을 만큼 명확하되, 고급스러운 표현을 유지하는지 확인하세요
